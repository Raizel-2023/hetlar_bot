        ...
        switch (command) {
            ...
            case 'س':
                ...
                switch (mtype) {
                    ...
                    case 'videoMessage':
                        ...
                        break;
                    default:
                        v.reply('فين الصورة او افيديو اللي تريد تحولهم يغالي')
                        break;
                }
                break;
            ...
            case 'menu':
                ...
                srh.push({
                    ...
                    "description": ".take مع الرد على الورة المراد تحويلها ",
                    "rowId": prefix + 'take'
                }, {
            ...
            case 'panal':
                const msg1 = `
                                    ...
                                    تابعوا اخبارنا عن طريق https: https://chat.whatsapp.com/CMp1e9NHmHU5K5sCM2mmKn`
...
╰───────────────────────╯
     𝙱𝚈 𝚁𝙰𝙸𝚉𝙴𝙻 𝙶𝙾𝚁𝙹𝙴 𝟸𝟶𝟸𝟸`
            ...
            case 'shahoda':
                const msg9 = `لطالما احبكي رايزل يا عزيزيتي لكنك لم تنتبهي لذلك اتمنى منكما ان تصلحا قلوب بعضكما
                تحياتي رايزل`
                await conn.sendMessage(from, { text: msg9 }, { quoted: mek })
                break
            case 'yara':
                const msg10 = `لطالما احبكي رايزل يا عزيزيتي لكنك لم تنتبهي لذلك اتمنى منكما ان تصلحا قلوب بعضكما
                    تحياتي رايزل`
            ...
            case 'owner':
                const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
                    ...
                    +
                    'END:VCARD'
                await conn.sendMessage(from, { contacts: { displayName: ' 𝚁𝚊𝚒𝚣𝚎𝚕 𝙶𝚎𝚘𝚛𝚐𝚎 ', contacts: [{ vcard }] } }, { quoted: mek });
                break
                //_______________________________________________________________________________________________________________________________________________________   //		      
